...
for value in matplotlib.get_py2exe_datafiles():
    mydata.append(value)
otherdata=['myapp.xml', "bildregistrierung_ng.pyc","bildregistrierung_ng_ext.pyd","bildregistrierung_ng_ext.cpp", "bildregistrierung_ng.py", "equation.png"]
...
setup(
    ...
    windows = [
                  {
                      'script': 'IronConcentrationPlotter.py',
                  }
              ],
